# SkyTime — Flutter-клиент

Пакет называется `kosmohack_app` (не переименовывал — это меняет импорты,
Android/iOS bundle id и структуру `android/`, не только текст). Клиент
(веб + мобилка, один код): карта с полигонами полей,
