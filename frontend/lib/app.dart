  ...
  Widget build(BuildContext context) {
    final router = GoRouter(
      ...
      routes: [
        GoRoute(
          path: '/',
          // Корень — лендинг команды (см. screens/home_screen.dart): не
          // зависит от бэкенда/авторизации, поэтому конструктору ничего
          // передавать не нужно. Полноразмерная карта на демо-данных —
          // на /map, туда ведут кнопки лендинга.
